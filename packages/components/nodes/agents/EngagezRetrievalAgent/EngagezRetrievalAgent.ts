...
class EngagezRetrievalAgent_Agents implements INode {
    label: string
    name: string
    version: number
    description: string
    ...
    constructor() {
        this.label = 'Engagez Retrieval Agent'
        this.name = 'engagezRetrievalAgent'
        this.version = 3.0
        this.type = 'AgentExecutor'
        this.category = 'Agents'
        this.icon = 'agent.svg'
        this.description = `An Engagez agent optimized for retrieval during conversation, answering questions based on past dialogue, all using OpenAI's Function Calling`
...
module.exports = { nodeClass: EngagezRetrievalAgent_Agents }
